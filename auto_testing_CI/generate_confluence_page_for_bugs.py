...
def generate_confluence_page_for_bugs(user, password, bugs):
	...
	info_header_html = '<p>' + "The report is generated by CI_3(ET QE Build Testing CI) automatically." + '</p>'
	...
	html = info_header_html + page_notice_html + info_for_manual_testing_html + formatted_manual_bugs_html + info_for_automated_testing_html + formatted_automated_bugs_html
